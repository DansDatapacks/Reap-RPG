...
#summon
execute as @s at @s anchored feet run summon area_effect_cloud ~ ~ ~ {Duration:1,RadiusPerTick:-0.003f,Radius:1f,Tags:["dan.editTomeAEC","global.ignore"],Particle:"entity_effect",Color:16734553,Potion:"minecraft:healing"}
