# gives poison effect (runs as effected mob)
...
#set score
execute unless score @s dan.tome_dmgPsn > @s dan.temp run scoreboard players operation @s dan.tome_dmgPsn = @s dan.temp
#reset temp
scoreboard players reset @s dan.temp

#set timer
scoreboard players set @s dan.tome_effPsn 120
